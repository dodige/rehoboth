...
#        pass
    ...
    keepratio1= True
    keepratio2= True
    option1 = "-o both --layer 1 -g"
    option2 = "-o hdmi --layer 2 -g"
    movie1 = "/home/pi/4.mp4"
    movie2 = "/home/pi/3.mp4"


    movie3 = "/home/pi/2.mp4"
    option3 = "-o hdmi --layer 3 -g --dbus_name com.dodo.test"
    x3=250
    y3=300
    width3=500
    height3=700
    ...
    vid1 =  Service.Play(movie1, x1, y1, width1, height1, keepratio1, option1)
    vid2 = Service.Queue(movie2, x2, y2, width2, height2, keepratio2, option2)
    vid3 = Service.Queue(movie3, x3, y3, width3, height3, keepratio3, option3)
...
#    vid1.Pause()
    ...
    #busq = dbus.SystemBus()
    busq = dbus.SessionBus()
    print busq
    print("1")
    bar = busq.get_object("raspberry.pi.OMXPlayer", vid1)
    print("2")
    print bar
    baz = busq.get_object("raspberry.pi.OMXPlayer", vid3)
    print("3a")
    print baz
    print("3b") 
    v1 = dbus.Interface( bar , 'raspberry.pi.OMXPlayer')
    print v1  



    introspection_interface = dbus.Interface(bar,dbus.INTROSPECTABLE_IFACE)
